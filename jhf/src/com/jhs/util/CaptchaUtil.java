 ...
 *
 */
public class CaptchaUtil extends Render{
	...
	public CaptchaUtil(String randomKey,int width, int height, int count, boolean isCaseInsensitive) {
		if (randomKey == null || randomKey.equals(""))
			throw new IllegalArgumentException("randomKey can not be blank");
		randomCodeKey = randomKey;
