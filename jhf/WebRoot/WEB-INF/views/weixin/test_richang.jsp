...
<body onload="init('${openId}')">
	<div class="w-panel-group">
		...
		<div id="page1" class="w-panel">
			<div class="w-panel-title">脸部症状有哪些</div>
			<div class="w-panel-content">
				...
				<table class="face" style="margin-top: 10px;">

					<tr>
						<td align="center"><img style="width: 200px;"
							src="${pageContext.request.contextPath}/static/images/check_face2.png" /></td>
					</tr>
					<tr>
						<td align="center">
							<div style="width: 258px; height: 100px; margin-top: 10px;">
								<div id="type1" class="types" state="0"
									style="float: left; width: 80px; margin: 3px; height: 26px; font-size: 13px; line-height: 26px; text-align: center; color: #666; border: 1px solid #fe6b5b; border-radius: 15px;">有黑头</div>

								<div id="type2" class="types" state="0"
									style="float: left; width: 80px; margin: 3px; height: 26px; font-size: 13px; line-height: 26px; text-align: center; color: #666; border: 1px solid #fe6b5b; border-radius: 15px;">毛孔粗大</div>

								<div id="type3" class="types" state="0"
									style="float: left; width: 80px; margin: 3px; height: 26px; font-size: 13px; line-height: 26px; text-align: center; color: #666; border: 1px solid #fe6b5b; border-radius: 15px;">有色斑</div>

								<div id="type4" class="types" state="0"
									style="float: left; width: 80px; margin: 3px; height: 26px; font-size: 13px; line-height: 26px; text-align: center; color: #666; border: 1px solid #fe6b5b; border-radius: 15px;">易过敏</div>

								<div id="type5" class="types" state="0"
									style="float: left; width: 80px; margin: 3px; height: 26px; font-size: 13px; line-height: 26px; text-align: center; color: #666; border: 1px solid #fe6b5b; border-radius: 15px;">油脂旺盛</div>

								<div id="type6" class="types" state="0"
									style="float: left; width: 80px; margin: 3px; height: 26px; font-size: 13px; line-height: 26px; text-align: center; color: #666; border: 1px solid #fe6b5b; border-radius: 15px;">角质死皮多</div>

								<div id="type7" class="types" state="0"
									style="float: left; width: 80px; margin: 3px; height: 26px; font-size: 13px; line-height: 26px; text-align: center; color: #666; border: 1px solid #fe6b5b; border-radius: 15px;">有红血丝</div>

								<div id="type8" class="types" state="0"
									style="float: left; width: 80px; margin: 3px; height: 26px; font-size: 13px; line-height: 26px; text-align: center; color: #666; border: 1px solid #fe6b5b; border-radius: 15px;">干燥干裂</div>

								<div id="type9" class="types" state="0"
									style="float: left; width: 80px; margin: 3px; height: 26px; font-size: 13px; line-height: 26px; text-align: center; color: #666; border: 1px solid #fe6b5b; border-radius: 15px;">发炎红肿</div>
							</div>
						</td>
					</tr>
					<tr>
						<td align="center" style="height: 50px;"><button id="first3"
...
<script
	src="${pageContext.request.contextPath}/static/script/weixin/heitou.js"></script>
<script type="text/javascript"
