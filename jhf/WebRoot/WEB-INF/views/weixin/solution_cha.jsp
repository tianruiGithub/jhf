...
<body>
	<div class="page" data-role="page" id="pageone">
		<div data-role="main" class="ui-content">
			<img class="c-image" alt="" src="${pageContext.request.contextPath}/static/images/sol_cha_title.jpg">
			...
			<div class="c-box" style="margin-bottom:10px;">
				...
				<div class="c-content">&nbsp;500ml沸水闷泡10分钟，可依据个人口味加入冰糖、蜂蜜等，一日两次。</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		var cha = ${res};
		$.each(cha.zfList, function(i, item) {
			$("#list").append('<tr><td align="center" style="width:50%;border-right:1px solid #f0f0f0;">'+item.zf.name+'</td><td align="center">'+item.zf.weight+'</td></tr>');
		});
	</script>
</body>
</html>
